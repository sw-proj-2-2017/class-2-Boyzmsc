...
class HangmanGame(QWidget):
    ...
    def guessClicked(self):
        ...
        if re.search('[^a-z]', guessedChar):
            self.message.setText('Type again please!')
            return
        ...
        currentshape_display = self.hangman.currentShape()
        self.hangmanWindow.setText(currentshape_display)
        current_display = self.guess.displayCurrent()
        self.currentWord.setText(current_display)
        gueesed_display = self.guess.displayGuessed()
        self.guessedChars.setText(gueesed_display)
        ...
        if self.guess.finished():
            self.message.setText("Success! / "+self.guess.secretWord)
            self.gameOver = True
